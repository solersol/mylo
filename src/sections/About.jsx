  ...
  return (
    <section id="about" className="w-full flex flex-col lg:flex-row justify-center items-center min-h-screen gap-10 px-40 pt-0 mt-0 pb-0 mb-0">
      <div className="lg:w-7/12 p-4">
        <h1 className="font-anton text-[50px] mb-4 text-white">WHO's $MYLO</h1>
        <h2 className="font-anton text-[30px] mb-4 text-white">
          $MYLO LEARNT FROMT HE LEGEND HOUSINI HIMSELF THEY SAY CATS HAVE 7 LIVES BUT %MYLO IS INMORTAL<br/>
